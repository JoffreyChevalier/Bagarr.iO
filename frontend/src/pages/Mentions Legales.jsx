  ...
  return (
    <Body>
      ...
      <div className="flex-col font-standard_font">
        <h2 className="font-title_font text-lg mb-2">
          ARTICLE 1 : Les mentions légales
        </h2>
        <p>
          L’édition et la direction de la publication du site Bagarr.iO est
          assurée par Bagarr.iO, domicilié 33 rue de l'imposteur. Numéro de
          téléphone est 05 56 33 29 64 Adresse e-mail bagarr.io@jsteam.com.
          L'hébergeur du site Bagarr.iO est la société Bagarr.iO, dont le siège
          social est situé au 33 rue de l'imposteur, avec le numéro de téléphone
          : 05 56 33 29 64.
        </p>
        <br />
        <h2 className="font-title_font text-lg mb-2">
        ...
        <p>
          Le site Bagarr.iO permet à l'Utilisateur un accès gratuit aux services
          suivants : Le site internet propose les services suivants : Création
          d'un tournoi personnalisé, classement des joueurs Le site est
        ...
        <p>
          ...
          d'auteur. La marque Bagarr.iO est une marque déposée par Jeoffrey,
          Virginie, Carolina et Grischka.Toute représentation et/ou reproduction
          et/ou exploitation partielle ou totale de cette marque, de quelque
          nature que ce soit, est totalement prohibée. L'Utilisateur doit
        ...
        <p>
          Les sources des informations diffusées sur le site Bagarr.iO sont
          ...
          Malgré des mises à jour régulières, le site Bagarr.iO ne peut être
          ...
          l’information contenue dans ce site. Le site Bagarr.iO ne peut être
        ...
        <p>
          ...
          Bagarr.iO. Ce dernier n’a pas de contrôle sur les pages web sur
          lesquelles aboutissent ces liens et ne saurait, en aucun cas, être
          responsable de leur contenu.
        </p>
        <br />

        <h2 className="font-title_font text-lg mb-2">ARTICLE 7 : Cookies</h2>
        <p>
          ...
          navigateur et qui sont nécessaires à l’utilisation du site Bagarr.iO.
          ...
          améliorer le site Bagarr.iO. En naviguant sur le site, L’Utilisateur
          les accepte. L’Utilisateur pourra désactiver ces cookies par
