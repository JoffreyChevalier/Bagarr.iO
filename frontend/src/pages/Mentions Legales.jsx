        ...
        <div className="flex-col justify-center pb-12">
          ...
          <div className="flex-col font-standard_font">
            ...
            <p>
              ...
              L'hébergeur du site Bagarr.iO est la société Bagarr.iO, dont le
              siège social est situé au 33 rue de l'imposteur, avec le numéro de
              téléphone : 05 56 33 29 64.
            </p>
            <br />
            <h2 className="font-title_font text-lg mb-2">
            ...
            <p>
              Le site Bagarr.iO permet à l'Utilisateur un accès gratuit aux
              services suivants : Le site internet propose les services suivants
              : Création d'un tournoi personnalisé, classement des joueurs Le
            ...
            <p>
              ...
              droit d'auteur. La marque Bagarr.iO est une marque déposée par
              Jeoffrey, Virginie, Carolina et Grischka.Toute représentation
              et/ou reproduction et/ou exploitation partielle ou totale de cette
            ...
            <p>
              ...
              Bagarr.iO ne peut être tenu responsable de la modification des
              ...
              dans ce site. Le site Bagarr.iO ne peut être tenu pour responsable
            ...
            <p>
              ...
              du site Bagarr.iO. Ce dernier n’a pas de contrôle sur les pages
            ...
            <p>
              ...
              site Bagarr.iO. Les cookies ne contiennent pas d’information
              personnelle et ne peuvent pas être utilisés pour identifier
              quelqu’un. Un cookie contient un identifiant unique, généré
              aléatoirement et donc anonyme. Certains cookies expirent à la fin
              de la visite de l’Utilisateur, d’autres restent. L’information
              contenue dans les cookies est utilisée pour améliorer le site
              Bagarr.iO. En naviguant sur le site, L’Utilisateur les accepte.
